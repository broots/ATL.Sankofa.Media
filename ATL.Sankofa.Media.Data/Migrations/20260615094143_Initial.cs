        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CloudflareLiveInputId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    RtmpsUrl = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    RtmpsStreamKey = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    SrtUrl = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    WebRtcUrl = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    HlsPlaybackUrl = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    ...
                    ConcurrentViewers = table.Column<long>(type: "bigint", nullable: false),
                    TotalViewers = table.Column<long>(type: "bigint", nullable: false),
                    ScheduledStartTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ActualStartTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EndTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RecordStream = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", maxLength: 5000, nullable: true),
                    CloudflareVideoId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    CloudflareVideoUrl = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    ThumbnailUrl = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    HlsPlaybackUrl = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    DashPlaybackUrl = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LiveStreams_CloudflareLiveInputId",
                table: "LiveStreams",
                column: "CloudflareLiveInputId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscriptions_UserId_ChannelId_Status",
                table: "Subscriptions",
                columns: new[] { "UserId", "ChannelId", "Status" });
